    ...
    >
      <template v-slot:prepend>
        <div
          ...
          @click="
            !tokenInIsLbpToken ? openModalSelectToken('input') : undefined
          "
        >
          <BalAsset
    ...
    >
      <template v-slot:prepend>
        <div
          class="flex items-center w-32 h-full cursor-pointer"
          @click="
            !tokenOutIsLbpToken ? openModalSelectToken('input') : undefined
          "
        >
          <BalAsset
