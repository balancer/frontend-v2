...
const POOLS_MAINNET: Pools = {
  ...
  Stable: {
    AllowList: [
      ...
      '0x5b3240b6be3e7487d61cd1afdfc7fe4fa1d81e6400000000000000000000037b', // DOLA stable pool
      '0x5b3240b6be3e7487d61cd1afdfc7fe4fa1d81e6400000000000000000000037b', // INV stable pool
    ],
  },
  Investment: {
    AllowList: [
