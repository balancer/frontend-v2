...
export const TOKEN_LIST_MAP: TokenListMapByNetwork = {
  ...
  '100': {
    Balancer: {
      Default:
        'https://raw.githubusercontent.com/Matthews3301/balancer-assets/refactor-for-multichain/generated/gnosis.listed.tokenlist.json',
      Vetted:
        'https://raw.githubusercontent.com/Matthews3301/balancer-assets/refactor-for-multichain/generated/gnosis.vetted.tokenlist.json',
    },
    External: [
