...
export type Web3Response = ReturnType<typeof web3Provider>;
export const Web3ProviderSymbol: InjectionKey<Web3Response> = Symbol(
...
export const useWeb3Plugin = (): Web3Response => {
