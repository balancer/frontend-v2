<template>
  <div class="pb-4">
    ...
    <div class="subsection">
      <h2>1. Overview</h2>
      <p>
        This Sobal Terms of Use document (“Terms” or “agreement”) ("Sobal”, “we”
        and “us” refers to the Sobal Foundation) covers the website, Sobal
        ...
        provides the ability to access the decentralized Sobal Protocol.
        Additionally, you can access the Sobal Protocol through third-party web
      ...
      <p>
        ...
        changes to the Terms. Sobal in its sole discretion, reserves the right
    ...
    <div class="subsection">
      <h2>2. Site</h2>
      <p>
        As part of the Site, Sobal provides access to a decentralized finance
        application (“Application” or “Sobal Protocol app”) on the Neon
        blockchain, that allows swappers or liquidity providers of Neon assets
        (“Cryptocurrency Assets”) to transact using smart contracts (“Smart
        Contracts”). Use of the Sobal Protocol may require that you pay a fee,
        such as gas charges on the Neon network to perform a transaction. You
        acknowledge and agree that Sobal has no control over any activities,
        transactions, the method of payment of any transactions, or any actual
        processing of payments of transactions. You must ensure that you have a
        sufficient balance to complete any transaction on the Sobal Protocol
        before initiating such transaction. You should not take or refrain from
        taking any action based on any information contained on the Site or any
        other available information at any time. Before you make any legal,
      ...
      <p>
        You acknowledge and agree that Sobal has no control over any
        transactions conducted through the Sobal Protocol, the method of payment
        ...
        applicable cryptocurrency tokens stored at your Sobal
        Protocol-compatible wallet address (“Cryptocurrency Wallet”) to complete
        any transaction on the Sobal Protocol or the Neon network before
    ...
    <div class="subsection">
      ...
      <ul>
        ...
        <li>
          Export, reexport, or transfer, directly or indirectly, any Sobal
        ...
        <li>
          ...
          the Site or the Sobal Protocol, or that could damage, disable,
          overburden, or impair the functioning of the Site or the Sobal
          Protocol in any manner;
        </li>
        <li>
          Attempt to circumvent or disable any content filtering techniques or
          security measures that Sobal employs on the Site, or attempt to access
          any service or area of the Site that you are not authorized to access;
        </li>
        <li>
    ...
    <div class="subsection">
      ...
      <ul>
        <li>
          Losses while digital assets are being supplied to the Sobal Protocol
        ...
        <li>
          Risks associated with accessing the Sobal Protocol through third party
        ...
        <li>
          Although Sobal does not have access to your assets, you are reminded
          and acknowledge that at any time, your access to your Cryptocurrency
          Assets through third party wallet services, unrelated to Sobal or the
          Sobal.Fi website, may be suspended or terminated or there may be a
      ...
      <ol>
        ...
        <li>
          that you expressly waive and release Sobal from any and all liability,
          claims, causes of action, responsibility or damages arising from or in
          any way related to your use of the Site, the Application or the Smart
          Contracts.
        </li>
        <li>
          upgrades and modifications to the protocol are managed in a
          community-driven way by holders of the Sobal Protocol governance
          token. No developer or entity involved in creating the Sobal Protocol
          ...
          the Sobal Protocol, including any direct, indirect, incidental,
    ...
    <div class="subsection">
      ...
      <p>
        Sobal is the owner of all intellectual property rights in the Site and
        ...
        www.Sobal.fi is the uniform resource locator (‘URL’) of Sobal. You will
        not make use of this URL (or any other URL owned by us) on another
    ...
    <div class="subsection">
      ...
      <p>
        <em class="font-semibold">
          ...
          liability of Sobal and our officers, directors, employees,
    ...
    <div class="subsection">
      ...
      <p>
        You agree to indemnify and hold Sobal and our officers, directors,
    ...
    <div class="subsection">
      ...
      <p>
        ...
        agreement between you and us with respect to your use of the site, Sobal
        and the services provided via the site and supersede any and all prior
        or contemporaneous representations, communications or agreements
      ...
      <p>
        <em class="font-semibold"
          ...
          choice of law determined in Sobal’s sole discretion.</em
        >
      </p>
      <p>
        <em class="font-semibold">
          ...
          agreement, you and Sobal are each waiving the right to a trial by jury
    ...
    <div class="subsection">
      ...
      <p>
        ...
        majeure events, Sobal is under no obligation to take any corrective
    ...
    <div>
      <h2>12. Contact Us</h2>
      <p>
        Sobal Inc is a foundation company organized in the British Virgin
        Islands (BVI). Please contact us if you have any questions about these
        Terms or other topics, by sending an email to
        <a class="link" href="mailto:hello@sobal.fi">hello@sobal.fi</a>.
      </p>
    </div>
  </div>
</template>
