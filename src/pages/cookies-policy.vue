<template>
  <div class="pb-4">
    ...
    <div class="subsection">
      ...
      <p>
        We do not generally use cookies; however our third party vendors do. We
        do not intentionally collect information to customize your experience on
        the website or the Balancer.fi user interface (UI) to the Balancer
        Protocol. (“Sites” or “Site”).
      </p>
      <p>
      ...
      <p>
        Other parties that collect information about your web browsing behavior
        when you use our Site are generally limited to service providers who
        only use any information collected to provide services for us and not to
        provide services or advertising for any other party. Note, however, that
        we also provide certain widgets or tools on our sites that allow you to
        interact with third parties who provide these features, such as tools
        that allow web surfers to easily share information on another platform.
        At other times, information from a third party may be embedded on our
        Site, such as a map. These widgets, tools, and informational items often
        function through the use of third-party cookies utilized by the third
        party site. As a result, these third parties may have access to
        information about your web browsing on the pages of our Site where these
        widgets, tools, or information are placed. You may wish to review
        information at third party sites, where you have an account, to
        determine how these third parties treat data that they obtain through
        the use of cookies.
      </p>
    </div>
    ...
    <div class="subsection">
      ...
      <p>
        ...
        beacons, and clear GIFs. We permit third-party service providers to use
        these technologies. They use these technologies for purposes such as
        determining viewing and response rates.
      </p>
    </div>
    <div class="subsection">
    ...
    <div>
      <h2>VI. Sharing</h2>
      <p>
        We share information with service providers with whom we work, such as
        service providers and companies that help us service you better. When
