<template>
  <div class="pb-4">
    <div class="subsection">
      <h1>Sobal Privacy&nbsp;Policy</h1>
      <p><em>Last Updated: July 2023</em></p>
      <p>
        <em class="font-medium">
          This Privacy Policy explains how Sobal (“Sobal,” “we,” “our,” or “us”)
          collects, uses, and discloses information about you. This Privacy
          Policy applies when you use our website, Sobal Protocol user-interface
          or application and other online products (collectively, our “UI”),
    ...
    <div class="subsection">
      ...
      <ul>
        <li>
          Sobal does not typically request, collect or use personal information.
          With the exception of your wallet address, there is no reason for you
          to provide personal information when you use the UI.
        </li>
        <li>
          Sobal does not and has not stored personal information from users of
          the UI. However, Sobal uses third party services including, without
          limitation, Cloudflare who may collect and store certain user
          information only for use in the provision of their services.
        </li>
        <li>
          Sobal does not set any cookies. However, it’s possible we may use
    ...
    <div class="subsection">
      ...
      <p>
        Sobal is not directed to children under the age of 16. If a parent or
        ...
        <a class="link" href="mailto:hello@sobal.fi">hello@sobal.fi</a>. If we
        become aware that a child under the age of 16 has provided us with
        personal information, we will take reasonable efforts to delete such
      ...
      <p>
        ...
        service providers. Your wallet and IP address is accessible to Sobal and
        its vendor(s). We may make inferences about you based on your wallet or
        IP address.
      </p>
    </div>
    <div class="subsection">
      ...
      <ul>
        <li>Ensure proper functioning of Sobal and the UI;</li>
        <li>
        ...
        <li>
          ...
          rights and property of Sobal and others;
        </li>
    ...
    <div class="subsection">
      ...
      <p>
        ...
        other than as described herein, in the normal course of Sobal business.
        However, when Sobal has access to personal information, such as your
      ...
      <ul>
        ...
        <li>
          ...
          the rights, property, and safety of Sobal, the Sobal ecosystem, the
          public, or others.
        </li>
        <li>
        ...
        <li>
          Personal information may be shared between and among Sobal and our
    ...
    <div class="subsection">
      ...
      <p>
        Sobal is headquartered in the British Virgin Islands (BVI). Therefore,
        ...
        We will take steps to ensure that your personal information receives an
    ...
    <div class="subsection">
      ...
      <h3>Cookies</h3>
      <p>
        Sobal does not typically use any cookies. It reserves the ability to use
        them to affect the availability and functionality of the UI. For more
        information about cookies and how to disable them, see our
        <router-link :to="{ name: 'cookies-policy' }">
    ...
    <div class="subsection">
      ...
      <p>
        Sobal does not “sell” personal information to advertise our products to
        you or otherwise.
      </p>
      ...
      <p>
        ...
        <a class="link" href="mailto:hello@sobal.fi">hello@sobal.fi</a>. If we
        receive your request from an authorized agent, we may ask for evidence
        that you have provided such agent with a power of attorney or that the
      ...
      <p>
        Sobal does not share such information with third parties for direct
        marketing purposes.
      </p>
    ...
    <div class="subsection">
      ...
      <p>
        Sobal does not typically process user personal data. If Sobal processes
        data, such as a wallet address and certain IP addresses, it will do so
      ...
      <p>
        ...
        certain processing. Sobal does not typically hold or store such personal
        data.
      </p>
    </div>
    <div>
