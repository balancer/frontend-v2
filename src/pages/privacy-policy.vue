  ...
  <div class="pb-4">
    ...
    <div class="subsection">
      ...
      <ul>
        ...
        <li>
          Balancer does not and has never stored any personal information from
          users of the UI. However, Balancer uses third party services including
          without limitation Cloudflare and Fathom Analytics who may collect and
          store certain user information only for use in the provision of their
          services.
        </li>
        <li>
