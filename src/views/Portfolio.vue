            ...
            <div class="grid grid-cols-2">
              ...
              >
                <div class="p-5 border-r md:border-r-0">
                  <div v-text="$t('apy', [$t('weekAbbrev')])" class="text-base" />
                  <div v-text="`${_num(12.34)}%`" class="font-bold text-xl" />
                </div>
                <div class="p-5 border-r md:border-r-0">
                  <div v-text="$t('profit', [$t('weekAbbrev')])" class="text-base" />
              ...
              >
                <div class="p-5 border-r md:border-r-0">
                  <div v-text="$t('apy', [$t('yearAbbrev')])" class="text-base" />
                  <div v-text="`${_num(12.34)}%`" class="font-bold text-xl" />
                </div>
                <div class="p-5 border-r md:border-r-0">
                  <div v-text="$t('profit', [$t('yearAbbrev')])" class="text-base" />
                  <div v-text="`${_num(5.6)}%`" class="font-bold text-xl" />
                </div>
                <div class="p-5">
                  <div v-text="$t('rank', [$t('weekAbbrev')])" class="text-base" />
