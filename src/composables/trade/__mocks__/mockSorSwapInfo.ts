export default function mockSorSwapInfo() {
  return {
    swapAmount: {
      _hex: '0x1bc16d674ec80000',
      _isBigNumber: true,
    },
    swapAmountForSwaps: {
      _hex: '0x1bc16d674ec80000',
    ...
    tokenOut: '0x616e8bfa43f920657b3497dbf40d6b1a02d4608d',
    marketSp: '0.01038601015730523093083359511345178',
    tokenInForSwaps: '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2',
    tokenOutFromSwaps: '0x616e8bfa43f920657b3497dbf40d6b1a02d4608d',
  };
}
