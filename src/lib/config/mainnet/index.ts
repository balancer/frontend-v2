...
const config: Config = {
  ...
  visibleInUI: true,
  testNetwork: false,
  rpc: `https://eth-mainnet.g.alchemy.com/v2/${keys.alchemy}`,
  ws: `wss://eth-mainnet.g.alchemy.com/v2/${keys.alchemy}`,
  explorer: 'https://etherscan.io',
  explorerName: 'Etherscan',
  subgraph: 'https://api.thegraph.com/subgraphs/name/balancer-labs/balancer-v2',
  balancerApi: 'https://to8cp89xdl.execute-api.eu-west-2.amazonaws.com/prod',
  poolsUrlV2:
